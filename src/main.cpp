 ...
 */
int testGridWorldLearning(unsigned short useAlgorithm){
	...
	GridDomain::GridDomainPtrT gridWorld(new GridDomain(gridX,gridY,goalX,goalY,blockX,blockY,pitX,pitY,defaultReward,goalReward,pitReward,sideActionP));
